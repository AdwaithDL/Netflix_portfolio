    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                ...
                , a Security Analyst focused on SOC operations, threat
                detection, and cloud security.
              </p>

              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                I work with SIEM and EDR platforms to monitor security events,
                investigate alerts, identify suspicious activity, and support
                incident response. I am also developing hands-on skills in AWS
          ...
          {/* Card 2: Certifications and Focus Areas */}
          <div
            ref={addToRefs}
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    Certified in{' '}
                    <strong className="text-white">CEH v13</strong>.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    ...
                    <strong className="text-white">SIEM and EDR</strong>{' '}
                    platforms.
                  </span>
                </li>
                ...
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    ...
                    <strong className="text-white">
                      incident investigation, threat hunting, and AWS security
                    </strong>
                    .
                  </span>
                </li>
            ...
            <div className="pt-6 font-mono text-xs text-white/40 relative z-10">
              // SEASON_01 SECURITY HIGHLIGHTS
            </div>
          </div>

          {/* Card 3: Security Toolkit */}
          <div
            ref={addToRefs}
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              ...
              <p className="text-base md:text-lg font-semibold text-white">
                Tools and technologies used for security monitoring and
                investigation.
              </p>
            </div>
