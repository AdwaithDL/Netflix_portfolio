...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Thanks ${formData.firstName}! Your message has been received.`);
        ...
        >
          ...
          <div className="flex items-center justify-between mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded bg-red-600/10 border border-red-600/30 text-xs font-mono uppercase tracking-widest text-red-500">
              ...
              <span>EPISODE 04 // SECURE CONTACT</span>
            </div>
              ...
              <div className="flex-1 flex flex-col">
                <div className="relative h-full flex flex-col">
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Tell me about a security role, project, or collaboration..."
                    required
            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4 pt-6 border-t border-white/10">
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/50 font-light">
                <p className="leading-relaxed max-w-[400px]">
                  For security-related opportunities, collaborations, or
                  professional discussions, please send a message through this
                  form.
                </p>

                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  <p className="max-w-[250px] leading-relaxed">
                    Interested in SOC operations, cloud security, or threat
                    detection? Let's connect.
                  </p>
