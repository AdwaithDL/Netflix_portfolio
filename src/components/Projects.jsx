...
const projectsData = [
  {
    ...
    description:
      'Investigated simulated security alerts by analyzing logs, identifying suspicious activity, correlating events, and documenting investigation findings.',
    tags: ['SIEM', 'Alert Triage', 'Log Analysis', 'MITRE ATT&CK'],
    match: '99%',
    episode: 'S01 E01',
  },
  {
    ...
    description:
      'Performed threat hunting exercises using indicators of compromise, suspicious processes, event correlation, and endpoint telemetry.',
    tags: ['Threat Hunting', 'IOC Analysis', 'EDR', 'YARA'],
    match: '98%',
    episode: 'S01 E02',
  },
  {
    ...
    description:
      'Practiced incident investigation workflows covering alert validation, root-cause analysis, containment recommendations, escalation, and remediation tracking.',
    tags: ['Incident Response', 'Root Cause', 'Containment', 'Reporting'],
    match: '97%',
    episode: 'S01 E03',
  },
  {
    ...
    description:
      'Configured and reviewed AWS security controls involving IAM, EC2, VPC, Security Groups, and CloudTrail in a hands-on cloud environment.',
    tags: ['AWS', 'IAM', 'EC2', 'VPC', 'CloudTrail'],
    match: '99%',
    episode: 'S01 E04',
  },
  {
    ...
    description:
      'Performed vulnerability assessment exercises using reconnaissance, service enumeration, vulnerability scanning, and security findings analysis.',
    tags: ['Nessus', 'Nmap', 'Nikto', 'Vulnerability Assessment'],
    match: '96%',
    episode: 'S01 E05',
  },
  {
    ...
    description:
      'Practiced web application security testing in controlled lab environments to understand common vulnerabilities and security testing methodologies.',
    tags: ['Burp Suite', 'OWASP Top 10', 'Gobuster', 'Web Security'],
    match: '98%',
    episode: 'S01 E06',
  },
  {
    ...
    description:
      'Created a security monitoring workflow to organize security events, highlight suspicious activity, and improve investigation visibility.',
    tags: ['SIEM', 'Dashboards', 'Event Correlation', 'Detection'],
    match: '97%',
    episode: 'S01 E07',
  },
  {
    title: 'Security Framework Mapping',
    category: 'Security Knowledge',
    description:
      'Mapped security events and investigation activities to frameworks such as MITRE ATT&CK, NIST, and OWASP Top 10.',
    tags: ['MITRE ATT&CK', 'NIST', 'OWASP', 'Threat Intelligence'],
    match: '98%',
    episode: 'S01 E08',
  },
];
