...
const expertiseData = [
  {
    ...
    text: 'Monitoring and analyzing security alerts across SIEM and EDR platforms to identify suspicious activity, investigate events, and support effective incident response.',
  ...
  },
  {
    ...
    text: 'Performing alert triage, event correlation, IOC analysis, and threat hunting to detect potential attacks and uncover malicious activity.',
  ...
  },
  {
    ...
    text: 'Investigating security incidents, analyzing root causes, supporting containment and remediation, and escalating critical findings when required.',
  ...
  },
  {
    ...
    text: 'Developing hands-on knowledge of AWS security services, IAM, EC2, VPC, Security Groups, and CloudTrail to strengthen cloud environments.',
    tag: 'AWS SECURITY',
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Protecting digital environments through security monitoring,
            threat detection, incident investigation, and cloud security.
          </p>
        </div>
